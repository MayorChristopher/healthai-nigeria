...
const slides = [
  {
    ...
    subtitle: '24/7 Medical Guidance for Rural Communities',
    content: (
    ...
    content: (
      <div className="space-y-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="bg-red-500/10 border-2 border-red-500/40 rounded-xl p-8 hover:bg-red-500/15 transition-all">
            <div className="text-6xl font-bold text-white mb-4">60%</div>
            <p className="text-white text-lg font-medium">Live 5km+ from nearest hospital</p>
          </div>
          <div className="bg-red-500/10 border-2 border-red-500/40 rounded-xl p-8 hover:bg-red-500/15 transition-all">
            <div className="text-6xl mb-4">🌙</div>
            <p className="text-white text-lg font-medium">No guidance during night emergencies</p>
          </div>
          <div className="bg-red-500/10 border-2 border-red-500/40 rounded-xl p-8 hover:bg-red-500/15 transition-all">
            <div className="text-6xl mb-4">🗣️</div>
            <p className="text-white text-lg font-medium">Language barriers prevent help-seeking</p>
          </div>
        </div>
        <p className="text-center text-xl text-gray-300 mt-8">Some families don't know what to do when emergencies happen</p>
      </div>
    )
  },
  {
    title: 'Our Solution',
    subtitle: 'Instant Medical Guidance, Anytime, Anywhere',
    content: (
      <div className="space-y-6">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
          <div className="bg-green-500/10 border-2 border-green-500/40 rounded-xl p-6 hover:border-green-500/60 transition-all">
            <h3 className="text-xl font-bold mb-2 text-white">AI Symptom Analysis</h3>
            <p className="text-gray-300">WHO-based medical guidance powered by Google Gemini</p>
          </div>
          <div className="bg-blue-500/10 border-2 border-blue-500/40 rounded-xl p-6 hover:border-blue-500/60 transition-all">
            <h3 className="text-xl font-bold mb-2 text-white">Nigerian Pidgin Support</h3>
            <p className="text-gray-300">First AI health assistant in Pidgin language</p>
          </div>
          <div className="bg-red-500/10 border-2 border-red-500/40 rounded-xl p-6 hover:border-red-500/60 transition-all">
            <h3 className="text-xl font-bold mb-2 text-white">Emergency Detection</h3>
            <p className="text-gray-300">Auto-identifies critical symptoms instantly</p>
          </div>
          <div className="bg-purple-500/10 border-2 border-purple-500/40 rounded-xl p-6 hover:border-purple-500/60 transition-all">
            <h3 className="text-xl font-bold mb-2 text-white">No Registration Required</h3>
            <p className="text-gray-300">Start chatting immediately - completely anonymous</p>
          </div>
        </div>
      </div>
    )
